    ...
    return (
        <div className="row">
            ...
            <div className="col">
                <div className="card shadow">
                    <div className="card-body">
                        <form className={formClass} onSubmit={handleSubmit} id="create-attendee-form">
                            <h1 className="card-title">It's Time!</h1>
                            <p className="mb-3">
                                Please choose which conference
                                you'd like to attend.
                            ...
                            <div className="mb-3">
                                <select onChange={handleChangeConference} value={conference} name="conference" id="conference" className="dropDownClass" required >
                                    <option value="">Choose a conference</option>
                            ...
                            <div className="row">
                                <div className="col">
                                    <div className="form-floating mb-3">
                                        <input onChange={handleChangeName} value={name} required placeholder="Your full name" type="text" id="name"
                                            name="name" className="form-control" />
                                        <label htmlFor="name">Your full name</label>
                                    </div>
                                </div>
                                <div className="col">
                                    <div className="form-floating mb-3">
                                        <input onChange={handleChangeEmail} value={email} required placeholder="Your email address" type="email" id="email"
                                            name="email" className="form-control" />
                                        <label htmlFor="email">Your email address</label>
                                    </div>
                                </div>
